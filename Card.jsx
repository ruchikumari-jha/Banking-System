...
const Card = ({ bank = 'HDFC', accountNo = '456789', holderName = 'RUCHI' }) => {
    ...
    return (
        <div className={`relative w-full max-w-md h-56 bg-linear-to-br ${gradient} rounded-3xl shadow-xl p-6 text-white overflow-hidden transform hover:scale-105 transition-transform duration-300`}>
            {/* Background Decor */}
