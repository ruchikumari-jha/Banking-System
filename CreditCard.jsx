                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-4xl">
                    ...
                    <div className="space-y-4">
                     ...
                     <div className="space-y-4 opacity-70">
                        ...
                        <div className="w-full h-56 bg-linear-to-br from-gray-800 to-gray-900 rounded-3xl p-6 text-white shadow-xl relative overflow-hidden flex flex-col justify-between">
